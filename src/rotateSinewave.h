...
public:
    ...
    void draw(int cF1X,int cF1Y)
	{
		...
		ofFill();
		ofSetColor(color1.x,color1.y,color1.z);                             //253,217,217
        ofCircle(pos.x+enMove1.x+cF1X,pos.y+enMove1.y+cF1Y,radius*amp.getValue());   //radius = 200;
        ofSetColor(color1.x,color1.y,color1.z);                             //220,214,217
        ofCircle(pos.x+enMove2.x+cF1X,pos.y+enMove2.y+cF1Y,radius*amp.getValue());
        ofSetColor(color1.x,color1.y,color1.z);                             //253,217,217
        ofCircle(pos.x+enMove3.x+cF1X,pos.y+enMove3.y+cF1Y,radius*amp.getValue());
	}
